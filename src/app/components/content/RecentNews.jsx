...
const newsEvents = [
  {
    ...
    thumbnail: "https://example.com/tech-conference.jpg"
  },
  {
    id: 2,
    ...
    thumbnail: "https://example.com/sports-festival.jpg"
  },
  {
    id: 3,
    ...
    thumbnail: "https://example.com/climate-summit.jpg"
  }
];
...
export default function RecentNews() {
  ...
  return (
    <div className="w-11/12 lg:w-4/5 mx-auto my-40">
      ...
      {/* Video Cards Grid */}
      <div className="">
        {newsEvents.map(news=> <NewsCard key={news.id}/>)}
      </div>
    </div>
  );
}
